...
const routes = [
  ...
  { path: '/dashboard', name: 'Dashboard', element: Dashboard },
  { path: '/url-inspector', name: 'URL İnceleme', element: UrlInspector },

  // SEO Routes
  { path: '/add-site', name: 'Site Ekle', element: AddSite },
  { path: '/keywords/:site', name: 'Anahtar Kelime Analizi', element: KeywordAnalysis },
  { path: '/traffic/:site', name: 'Trafik Analizi', element: TrafficAnalysis },
  { path: '/pages/:site', name: 'Sayfa Analizi', element: PageAnalysis },
  { path: '/competitors/:site', name: 'Rakip Analizi', element: CompetitorAnalysis },
  { path: '/reports/:site', name: 'Raporlar', element: Reports },
  { path: '/site-settings/:site', name: 'Site Ayarları', element: SiteSettings },

  // Settings
  { path: '/settings', name: 'Ayarlar', element: Settings },
]
